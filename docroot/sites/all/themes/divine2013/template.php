...
function divine2013_preprocess_node($vars) {
  
}
function divine2013_preprocess_html(&$vars) {
    
  $vars['classes_array'][] = 'divine-us';
  
  if (isset($vars['page']['content']['system_main']['nodes'][26])) {
    setcookie('divineus[data][email]',1,time()+31536000,"/","divinechocolateusa.com");
  }     
}
